...
var DocumentReference = /** @class */ (function () {
     ...
     */
    function DocumentReference(db, coll, docID, query) {
        this._db = db;
        this._coll = coll;
        this.id = docID;
     ...
     */
    DocumentReference.prototype.create = function (data, options) {
        var _a, _b;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._query
                                .where((_a = {}, _a[this._db.primaryKey] = this.id, _a))
                                .update(serialize(data), { merge: merge, multi: false, upsert: true })];
                    case 1:
                        res = _b.sent();
                        return [2 /*return*/, res];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        merge = true;
                        options = { merge: merge, multi: false, upsert: false };
                        return [4 /*yield*/, this._query
                                .where((_a = {}, _a[this._db.primaryKey] = this.id, _a))
                                .update(data, options)];
                    case 1:
     ...
     * 删除文档
     */
    DocumentReference.prototype.remove = function () {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this._query
                            .where((_a = {}, _a[this._db.primaryKey] = this.id, _a))
                            .remove({ multi: false })];
                    case 1:
                        res = _b.sent();
     ...
     * @param data - document data
     */
    DocumentReference.prototype.createIndex = function (keys, options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var data, params, res;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (typeof keys !== 'object' || ((_a = Object.keys(keys)) === null || _a === void 0 ? void 0 : _a.length) === 0) {
    ...
    DocumentReference.prototype.dropIndex = function (index) {
        return __awaiter(this, void 0, void 0, function () {
            var params, res;
    ...
    DocumentReference.prototype.listIndexes = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var params, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
